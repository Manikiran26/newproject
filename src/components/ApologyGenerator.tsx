...
export default function ApologyGenerator() {
  ...
  const handleDownload = () => {
    if (generatedApology) {
      const content = `APOLOGY LETTER
      
Tone: ${generatedApology.tone.charAt(0).toUpperCase() + generatedApology.tone.slice(1)}
Length: ${generatedApology.length.charAt(0).toUpperCase() + generatedApology.length.slice(1)}
...
---
Generated by ExcuseAI - Apology Generator
